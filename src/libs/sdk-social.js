const SOCIAL_PROVIDERS = {
  ...
  youtube: {
    ...
    buildEmbedUrl: (id) => `https://www.youtube.com/embed/videoseries?list=UU${id}`
  },
  facebook: {
    name: "Facebook",
    ...
    buildEmbedUrl: (id) => `https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F${id}&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId`
  },
  instagram: {
    name: "Instagram", 
